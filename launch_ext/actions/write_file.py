...
def write_file(context: LaunchContext, contents: SomeSubstitutionsType, dest_path: SomeSubstitutionsType, overwrite: bool=True):
...
def WriteFile(contents: SomeSubstitutionsType, dest_path: SomeSubstitutionsType) -> OpaqueFunction:
    """Action that writes a substituion to a file."""
    return OpaqueFunction(function=write_file, kwargs={
        'contents': contents,
        'dest_path': dest_path,
    })
